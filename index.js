    ...
    try {
        ...
        async function tryAnswerFn() {
            ...
            const res = await page.evaluate(async(answering, correct, wrong) => {
                ...
                return [correct, wrong, correct_count, viewed, answerlist, notAnswer];
            ...
            if (answering.length - viewed - res[5] > (answering.length - viewed) / 2) throw Error("程式不支援此類題型");
